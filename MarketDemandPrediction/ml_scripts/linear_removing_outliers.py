...
data_frame_1 = pd.read_csv("/Users/nikil/Desktop/MarketDemandPrediction/ml_scripts/newdata.csv")
data_frame_1.drop(data_frame_1[data_frame_1['Area'] != "Nigeria"].index, inplace=True)

data_frame_2 = pd.read_csv("/Users/nikil/Desktop/MarketDemandPrediction/ml_scripts/yield.csv")
